...
export function ChartCards({
  ...
  const dataBase = `${FOOTBALL_APP_BASE}/portal/data`;

  return (
    <div className="grid gap-4 md:grid-cols-3">
      <div className={cardShell}>
        <Link
          href={`${dataBase}/anthropometric`}
        ...
        <Link href={`${dataBase}/anthropometric`} className="mt-1 block text-center text-xs text-emerald-600 hover:underline">
          点击查看与编辑数据表
        </Link>
      </div>
      ...
      <div className={cardShell}>
        ...
        <Link href={`${dataBase}/speed`} className="mt-1 block text-center text-xs text-emerald-600 hover:underline">
          点击查看与编辑数据表
        </Link>
      </div>
      ...
      <div className={cardShell}>
        ...
        <Link href={`${dataBase}/activity`} className="mt-1 block text-center text-xs text-emerald-600 hover:underline">
          查看统计说明与每周数字
        </Link>
      </div>
    </div>
